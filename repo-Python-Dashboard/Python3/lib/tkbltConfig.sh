...
# String to pass to linker to pick up the tkblt library from its
# installed directory.
tkblt_LIB_SPEC='-L/home/dours_d/Documents/Python3/lib/tkblt3.2 -ltkblt3.2'
...
# String to pass to linker to pick up the tkblt stub library from its
# installed directory.
tkblt_STUB_LIB_SPEC='-L/home/dours_d/Documents/Python3/lib/tkblt3.2 -ltkbltstub3.2'
...
# String to pass to linker to pick up the tkblt stub library from its
# installed directory.
tkblt_STUB_LIB_PATH='/home/dours_d/Documents/Python3/lib/tkblt3.2/libtkbltstub3.2.a'
