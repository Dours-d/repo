...
# String to pass to linker to pick up the tkimg library from its
# installed directory.
tkimg_LIB_SPEC='-L/home/dours_d/Documents/Python3/lib/Img1.4.6 -ltkimg1.4.6'
...
# String to pass to linker to pick up the tkimg stub library from its
# installed directory.
tkimg_STUB_LIB_SPEC='-L/home/dours_d/Documents/Python3/lib/Img1.4.6 -ltkimgstub1.4.6'
...
# String to pass to linker to pick up the tkimg stub library from its
# installed directory.
tkimg_STUB_LIB_PATH='/home/dours_d/Documents/Python3/lib/Img1.4.6/libtkimgstub1.4.6.a'
