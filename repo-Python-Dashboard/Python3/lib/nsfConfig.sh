...
# installed directory.
NSF_INCLUDE_DIR="/home/dours_d/Documents/Python3/include"
NSF_INCLUDE_SPEC="-I${NSF_INCLUDE_DIR}"

# The name of the nsf library (may be either a .a file or a shared library):
NSF_LIB_FILE=libnsf2.2.0.so

# String to pass to linker to pick up the nsf library from its
# build directory.
NSF_BUILD_LIB_SPEC='-L/tmp/---warning-do-not-use----/nsf -lnsf2.2.0'

# String to pass to linker to pick up the nsf library from its
# installed directory.
NSF_LIB_SPEC='-L/home/dours_d/Documents/Python3/lib/nsf2.2.0 -lnsf2.2.0'

# The name of the NSF stub library (a .a file):
# NSF_STUB_LIB_FILE=libnsfstub2.2.0.a

# String to pass to linker to pick up the NSF stub library from its
# build directory.
NSF_BUILD_STUB_LIB_SPEC='-L/tmp/---warning-do-not-use----/nsf -lnsfstub2.2.0'

# String to pass to linker to pick up the NSF stub library from its
# installed directory.
NSF_STUB_LIB_SPEC='-L/home/dours_d/Documents/Python3/lib/nsf2.2.0 -lnsfstub2.2.0'

# Name of the NSF stub library with full path in build and install directory
NSF_BUILD_STUB_LIB_PATH='/tmp/---warning-do-not-use----/nsf/libnsfstub2.2.0.a'
NSF_STUB_LIB_PATH='/home/dours_d/Documents/Python3/lib/nsf2.2.0/libnsfstub2.2.0.a'
...
NSF_SHARED_LIB_SUFFIX=2.2.0.so
NSF_UNSHARED_LIB_SUFFIX=2.2.0.a

# the shell in whose installation dirs the nsf package is installed
NSF_COMPATIBLE_TCLSH=/home/dours_d/Documents/Python3/bin/tclsh8.6
