...
# String to pass to linker to pick up the tifftcl library from its
# installed directory.
tifftcl_LIB_SPEC='-L/home/dours_d/Documents/Python3/lib/Img1.4.6 -ltifftcl3.9.7'
...
# String to pass to linker to pick up the tifftcl stub library from its
# installed directory.
tifftcl_STUB_LIB_SPEC='-L/home/dours_d/Documents/Python3/lib/Img1.4.6 -ltifftclstub3.9.7'
...
# String to pass to linker to pick up the tifftcl stub library from its
# installed directory.
tifftcl_STUB_LIB_PATH='/home/dours_d/Documents/Python3/lib/Img1.4.6/libtifftclstub3.9.7.a'
