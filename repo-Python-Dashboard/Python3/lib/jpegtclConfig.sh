...
# String to pass to linker to pick up the jpegtcl library from its
# installed directory.
jpegtcl_LIB_SPEC='-L/home/dours_d/Documents/Python3/lib/Img1.4.6 -ljpegtcl9.2'
...
# String to pass to linker to pick up the jpegtcl stub library from its
# installed directory.
jpegtcl_STUB_LIB_SPEC='-L/home/dours_d/Documents/Python3/lib/Img1.4.6 -ljpegtclstub9.2'
...
# String to pass to linker to pick up the jpegtcl stub library from its
# installed directory.
jpegtcl_STUB_LIB_PATH='/home/dours_d/Documents/Python3/lib/Img1.4.6/libjpegtclstub9.2.a'
