...
# installed.
TCL_PREFIX='/home/dours_d/Documents/Python3'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/dours_d/Documents/Python3'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/dours_d/Documents/Python3/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/dours_d/Documents/Python3/include'
...
TCL_PACKAGE_PATH='/home/dours_d/Documents/Python3/lib '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/dours_d/Documents/Python3/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/tmp/---warning-do-not-use----/tcl/unix/linux-shared/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/home/dours_d/Documents/Python3/lib/libtclstub8.6.a'
